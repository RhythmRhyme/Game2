...
global.JianZhen1 = [[0,0],[-50,-100],[50,100],[-100,-100],[100,100]];	//
global.JianZhen2 = [[0,0],[0,-160],[0,160],[0,-320],[0,320]];	//上下集中
global.JianZhen3 = [[0,0],[0,-64],[0,64],[0,-128],[0,128]];	//上下宽
global.JianZhen4 = [[0,0],[-320,-320],[320,320],[-320,320],[320,-320]];	//五点分布
//global.JianZhen4 = [[0,10],[8,3],[-8,3],[10,0],[-10,-10]];	//集中
global.JianZhen5 = [[0,0],[-160,0],[160,0],[-320,0],[320,0]];	//左右集中
global.JianZhen6 = [[0,0],[-320,0],[320,0],[-640,0],[640,0]];	//左右
global.JianZhen7 = [[0,0],[-640,0],[640,0],[-1280,0],[1280,0]];	//左右宽
